...
Links Found: ${content.links ? content.links.map(l => l.text + ' -> ' + l.href).join(', ') : 'None'}
Buttons Found: ${content.buttons ? content.buttons.map(b => b.text).join(', ') : 'None'}
Forms Found: ${content.forms ? content.forms.length + ' form(s)' : 'None'}
Headings: ${content.headings ? content.headings.map(h => h.text).join(', ') : 'None'}
